          ...
          {tab === 'New' ? (
            <View style={styles.card}>
              ...
              <TouchableOpacity
                ...
                disabled={loading}
              >
                <LinearGradient colors={['#00C9A7', '#009980']} style={styles.submitBtnGrad} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 16, padding: 4, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  fieldLabel: { fontSize: 12, fontWeight: '800', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
  categorySelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'rgba(0,0,0,0.2)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)', borderRadius: 16, paddingHorizontal: 16, paddingVertical: 16 },
  categorySelectorText: { fontSize: 16, color: '#fff', fontWeight: '600' },
  categoryOptions: { backgroundColor: 'rgba(10,10,26,0.95)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 16, marginTop: 8, overflow: 'hidden' },
  ...
  categoryOptionText: { fontSize: 15, color: 'rgba(255,255,255,0.7)' },
  categoryOptionTextActive: { color: '#00C9A7', fontWeight: '800' },
  
  textArea: { backgroundColor: 'rgba(0,0,0,0.2)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)', borderRadius: 16, padding: 16, fontSize: 16, color: '#fff', height: 150, marginBottom: 24 },
  ...
  complaintCard: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  complaintHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16 },
  categoryBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.08)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  complaintDate: { fontSize: 12, color: 'rgba(255,255,255,0.4)', fontWeight: '600' },
});
